                    ...
                    <div class="grid gap-4 sm:grid-cols-1 sm:gap-6">
                        ...
                        <div class="step">
                            ...
                            <div class="form-check mt-3">
                                ...
                                <x-form.form-input type="text" id="facebook" class="form-control" name="facebook" value="{{ old('facebook') }}"></x-form.form-input>
                            </div>
                            <div class="form-check mt-3">
                                <x-form.form-label for="twitter" class="form-label"> X(formerly known as Twitter) </x-form.form-label>
                                <x-form.form-input type="text" id="twitter" class="form-control" name="twitter" value="{{ old('twitter') }}"></x-form.form-input>
                            </div>
                            <div class="form-check mt-3">
                                <x-form.form-label for="instagram" class="form-label"> Instagram </x-form.form-label>
                                <x-form.form-input type="text" id="instagram" class="form-control" name="instagram" value="{{ old('instagram') }}"></x-form.form-input>
                            </div>
                            <div class="form-check my-3">
                                <x-form.form-label for="linkedin" class="form-label"> Linkedin </x-form.form-label>
                                <x-form.form-input type="text" id="linkedin" class="form-control" name="linkedin" value="{{ old('linkedin') }}"></x-form.form-input>
                            </div>
                        </div>
                        <div class="buttons">
